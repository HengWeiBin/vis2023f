...
<h3>從上圖中，我們可以看出：
  <ol>
    <li>填問卷的大部分人都是工作室的藝術工作者</li>
    <li>而大部分藝術工作者都通過減少包裝、使用再生材料、節約能源來減少碳排放</li>
    <li>當中如果仔細觀察，選擇“沒有”的人其實在每一種類型中的排名不弱大部分選項</li>
  </ol>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["非營利組織/藝術團體", "工作室", "替代空間", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源"])
  .range(["#FFC0CB", "#E6E6FA", "#F5F5DC", "#FFFDD0", "#FFE5B4", "#FBBEA1", "#FF8C69"])
  .unknown("#808080")
)}
